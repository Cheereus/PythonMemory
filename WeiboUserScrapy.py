...
class WeiboUserScrapy():
    ...
    def deal_html(self, url):
        """处理html"""
        try:
            html = requests.get(url, headers=self.headers, verify=False, data={"starttime": "20200401", "endtime": "20200901"}).content
...
if __name__ == '__main__':
    WeiboUserScrapy(user_id=5044281310, filter=1)
