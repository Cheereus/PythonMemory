...
f = open('Reverse_ID.txt', encoding='utf-8')
lines = f.readlines()
f.close()
data_my = []
data_my_over = []
...
# print(data_my_dict)
f = open('CFJY_YY_4789.reverse', encoding='utf-8')
lines = f.readlines()[1:]
f.close()
data_flip = []
data_flip_over = []
...
output = open('Flip_over.txt', 'w', encoding='utf-8')
for result in data_flip_over:
    output.writelines(result + '\n')
output.close()

output = open('My_over.txt', 'w', encoding='utf-8')
