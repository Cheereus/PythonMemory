...
lines = f.readlines()
f.close()
output_same_CFJY = open('CFJY_E.lst', 'w', encoding='utf-8')
output_same_SHQN = open('SHQN_E.lst', 'w', encoding='utf-8')
output_CFJY = open('CFJY_D.lst', 'w', encoding='utf-8')
CFJY = {}
...
output_SHQN = open('SHQN_F.lst', 'w', encoding='utf-8')
SHQN_same_counts = 0
